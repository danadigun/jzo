...
$(function () {
    ...
    function item_next() {
        ...
        $('.item_complete').show();
        //$('.item-add').show();
        $('.item-drop-message').html("<div class =\"alert alert-info\">" + "<b>Step 1 Complete. </b>Next upload item thumbnail image to finish!" + "</div>");
    ...
    Dropzone.options.itemDropzone = {
        ...
        init: function init() {
            ...
            this.on('success', function (file, response) {
                //on complete
                $('.item-drop-message').html("<div class =\"alert alert-success\">" + "<b>Success! </b>You have successfully created an item. Click <b>finish</b> to finish!" + "</div>" + "<div class=\"alert alert-info \">" + "You can simply replace image by uploading a new one" + "</div>");
    ...
    $('#EditModal').on('show.bs.modal', function (event) {
        ...
        $('form[name=update-item]').submit(function (e) {
            e.preventDefault();
        }).validate({
    ...
    function edit_item_next() {
        ...
        //$('.item-add').show();
        $('form[name=update-item] .edit-item-drop-message').html("<div class =\"alert alert-info\">" + "<b>Step 1 Complete. </b>Next upload item thumbnail image to finish!" + "</div>");
    ...
    Dropzone.options.editItemDropzone = {
        ...
        init: function init() {
            ...
            this.on('success', function (file, response) {
                //on complete
                $('.edit-item-drop-message').html("<div class =\"alert alert-success\">" + "<b>Success! </b>You have successfully created an item. Click <b>finish</b> to finish!" + "</div>" + "<div class=\"alert alert-info \">" + "You can simply replace image by uploading a new one" + "</div>");
