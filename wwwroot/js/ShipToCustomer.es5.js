...
$(function () {
    ...
    $('.ship-to').click(function (e) {
        ...
        $('#shipping_' + referenceId).html("<p class=\"alert alert-default\"><b><i>please confirm customer shipping details:<i><b></p>"
        ...
        $.ajax({
            ...
            if (callback.error) {
                ...
                var ship_address = $("<p class=\"well-ref well_" + referenceId + "\">" + "<b><i class=\"ion ion-ios-browsers-outline\"></i>&nbsp;Customer Shipping address:</b><br><br>" + "<b><i class=\"ion ion-android-drafts\"></i>&nbsp;&nbsp;</b>" + callback.user.mailingAddress + "<br><b><i class=\"ion ion-android-pin\"></i>&nbsp;&nbsp;</b>" + callback.user.city + ", " + callback.user.country + " </p>");

                $('#shipping_' + referenceId).append(ship_address);

                //proceed
                var proceed = $("<button class=\"btn btn-primary proceed-ship\" data-ship=\"" + referenceId + " \">Proceed</button>").click(function () {
                ...
                //cancel
                var cancel = $(" <button class=\"btn btn-default cancel-ship\" data-cancel=\"" + referenceId + " \">cancel</button>").click(function () {
